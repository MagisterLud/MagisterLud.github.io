...
These observations play an essential rôle in the generalizations of Hochschild homology.

> ### Example.
> Given a functor $F:\mathsf{Fin}\to k\text{-}\mathsf{mod}$, define *Hochschild homology of* $F$ as the homology of the following simplicial object:
> <div class="math"> 
> \begin{equation*}
> a_1\otimes...\otimes a_n\mapsto b_1\otimes...\otimes b_m, 
> \end{equation*}
...
Another definition can be done in the spirit of Example 1. For a commutative algebra $\mathcal{H}$, consider the corresponding Loday functor
